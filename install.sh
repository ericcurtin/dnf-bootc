...
main() {
  ...
  curl -fsSL -o "$tmp/rpm-ostree-to-bootc-generator.py" "$url/rpm-ostree-to-bootc-generator.py"
  ...
  install_755 "$tmp/rpm-ostree-to-bootc-generator.py" "/var/rpm-ostree-to-bootc-generator.py"
